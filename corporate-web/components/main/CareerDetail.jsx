  ...
  return (
    <main className="relative bg-white pb-28 md:pb-16">
      ...
      <HeroStatic 
        ...
        title={career.title}
        bgImageDesktop='https://d24cmpzg3ht16e.cloudfront.net/cms/shared/bg-career-detail.jpg'
        bgColor="bg-[#FFB800]"
        theme="light"
        heroSize="sm"
        ctaText="" 
      ...
      <section className="container py-6 md:py-12">
        <div className="flex flex-col md:flex-row gap-10 lg:gap-16 relative">
          ...
          <div className="w-full md:w-2/3 lg:w-3/4 flex flex-col gap-10">
            {career.description && (
              <div>
                ...
                <div className="text-body-b4 text-black space-y-3 [&_ul]:list-disc [&_ol]:list-decimal [&_ul]:ml-6 [&_ol]:ml-6 [&_li]:list-item" dangerouslySetInnerHTML={{ __html: career.description }} />
              </div>
            )}
            {career.requirements && (
              <div>
                <h2 className="text-headline-h5 font-bold text-black mb-4">Requirements</h2>
                <div className="text-body-b4 text-black space-y-3 [&_ul]:list-disc [&_ol]:list-decimal [&_ul]:ml-6 [&_ol]:ml-6 [&_li]:list-item" dangerouslySetInnerHTML={{ __html: career.requirements }} />
              </div>
            )}
            {career.benefit && (
              <div>
                <h2 className="text-headline-h5 font-bold text-black mb-4">Benefit</h2>
                <div className="text-body-b4 text-black space-y-3 [&_ul]:list-disc [&_ol]:list-decimal [&_ul]:ml-6 [&_ol]:ml-6 [&_li]:list-item" dangerouslySetInnerHTML={{ __html: career.benefit }} />
              </div>
            )}
          </div>
          ...
          <p className="careerDetail__privacyNote text-body-b5 mb-4 text-secondary mb-0 px-[10px] py-[8px] bg-[#f8f9fa] border-l-[3px] border-l-[#ffc107] rounded-r-[4px]">
            By applying, you agree to our&nbsp;
            <a href="/corporate-governance/privacy-notice" target="_blank" rel="noopener noreferrer" className="careerDetail__privacyLink font-medium text-warning underline">Privacy Notice</a>.
          </p>
