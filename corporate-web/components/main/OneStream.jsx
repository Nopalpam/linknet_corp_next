  ...
  return (
    ...
    <section id="one-stream" className="sectionProduct relative min-h-screen overflow-hidden flex items-center justify-center">
      ...
      <div className="container mx-auto py-6">
        ...
        <div className="flex flex-col-reverse md:flex-col md:flex-row items-center justify-between relative gap-10 md:gap-4">
            
            <div className="device-image device-image__left osplus-image w-full h-full" data-aos="fade-up" data-aos-delay="200">
                <img className='img-stb' src="https://d2fsl11s4twg7t.cloudfront.net/assets/devices/stb.png" alt="One Stream Plus Device" />
                <img className='img-remote' src="https://d2fsl11s4twg7t.cloudfront.net/assets/devices/remote.png" alt="One Stream Plus Device" />
            </div>
            <div className="sectionHead mb-8 md:mb-0 md:max-w-[50%]" data-aos="fade-up">
                    <img src="https://d2fsl11s4twg7t.cloudfront.net/assets/logos/logo-onestream-white.svg" className="h-9 w-auto" alt="" />
                    <h2 className="text-headline-h3 md:text-headline-h2 text-white mt-4 whitespace-pre-line">
                        <SplitText
                            text={t('title')}
                            delay={100}
                            duration={0.5}
                    ...
                    <div className="cta flex flex-wrap mt-8 gap-4">
                        <Button size='lg' variant='secondary-outline' onClick={() => openModal('get-onestream')}>
                            {t('textCTA')}
                        </Button>
                        <Button size='lg' variant='secondary-plain' onClick={() => openModal('onestream-specs')}>
                            {t('textCTA_secondary')}
                        </Button>
                    </div>
        ...
        <div className="swiperUSP relative">
          ...
          <div className="relative mt-5 w-full gap-5 z-20 flex items-center justify-end">
            ...
            <div className="flex gap-2">
                ...
                <button 
                    ...
                    className="w-14 h-10 rounded-full border border-white/20 flex items-center justify-center text-white hover:text-black  hover:bg-white transition-all disabled:opacity-30 disabled:cursor-not-allowed"
                >
         ...
         <Modal 
            isOpen={isModalOpen('onestream-specs')} 
            onClose={closeModal} 
          ...
          >
            ...
            {specifications.items.map((section, idx) => {
              ...
              return (
                <div key={idx} className={hasCategory ? "mb-8 last:mb-0" : "mb-2"}>
          ...
          <Modal 
            isOpen={isModalOpen('get-onestream')} 
            onClose={closeModal} 
