      ...
      <div className="lnCardEvent__media relative overflow-hidden rounded-[12px] md:rounded-[20px]">
        ...
        <div className="lnCardEvent__thumbnail aspect-[300/373] w-full overflow-hidden bg-neutral-100">
          {resolvedImage ? (
            ...
            <div className="flex h-full w-full items-center justify-center bg-[linear-gradient(135deg,#F5F5F5,#E8EEF7)] px-4 text-center text-body-b5 font-medium text-secondary">
              {title}
            </div>
          )}
        </div>
