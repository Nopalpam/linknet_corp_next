    ...
    return (
      ...
      >
        ...
        <div className="lnCardNews__footer cardFooter p-[20px] flex items-center justify-between mt-auto pt-2">
          ...
          {/* Arrow Circle */}
          <div className={`lnCardNews__action w-10 h-10 rounded-full bg-white flex items-center justify-center group-hover:border-neutral-300 group-hover:bg-neutral-50 transition-all shrink-0 text-black ${href ? '' : 'opacity-0'}`}>
