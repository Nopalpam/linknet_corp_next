export const ABOUT_VALUES_DATA = {
  "corporate-values": {
    ...
    introData: {
      as: "h2",
      label: "OUR VALUES",
      title: "Corporate Values Linknet",
      description: "Our values define who we are. They inspire us to act with integrity, work as one team, and create impact through innovation and excellence.",
      align: "center"
    },
    valuesList: [
      {
