...
export const CMS_COMPONENT_TYPES = {
  ...
  ENTERPRISE_CONSULTATION_FORM: 'enterprise_consultation_form',
  SMB_ENTERPRISE_FORM: 'smb_enterprise_form',
  ENTERPRISE_PARTNERSHIP_FORM: 'enterprise_partnership_form',
  ENTERPRISE_SOLUTION_FINDER_FORM: 'enterprise_solution_finder_form',
