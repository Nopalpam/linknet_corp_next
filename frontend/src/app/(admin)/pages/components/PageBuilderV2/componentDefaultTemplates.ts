...
export const slidersHeroDefaults = withCommon({
  slides: [
    ...
    },
    {
      ...
      button_text: { en: 'Apply Now', id: 'Daftar Sekarang' },
      button_link: '/apply',
  ...
  slides: [
    {
      ...
      cta_text: { en: 'Join as a First Squad', id: 'Bergabung sebagai First Squad' },
      cta_link: '#first-squad',
    },
    {
      ...
      cta_text: { en: 'Join as a Management Trainee', id: 'Bergabung sebagai Management Trainee' },
      cta_link: '#management-trainee',
    },
    {
      ...
      cta_text: { en: 'See Internship Openings', id: 'Lihat Lowongan Magang' },
      cta_link: '#first-squad-intern',
    },
  ],
});
