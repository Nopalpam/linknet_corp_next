...
const RadioCard = forwardRef(function RadioCard(
  {
    id,
    name,
    value,
  ...
  return (
    <label
      htmlFor={inputId}
      className={cx(
        'lnRadioCard relative flex h-[180px] w-[180px] cursor-pointer flex-col rounded-[16px] border bg-white px-6 py-7 text-center transition-colors duration-200',
        checked
      ...
      <span className="flex w-full flex-col items-center">
        {hasImage && (
          <span className={cx('mb-7 block h-[52px] w-[52px] shrink-0', hasText ? '' : 'mb-0', imageClassName)}>
            ...
            <img
              src={image}
              alt={imageAlt || displayText || 'Radio card image'}
