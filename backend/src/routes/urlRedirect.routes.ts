 ...
 * @access  Private (requires 'url_redirect.read' permission)
 */
router.get('/cms/url-redirects', authorize('url_redirect.read'), getUrlRedirects);
 ...
 * @access  Private (requires 'url_redirect.read' permission)
 */
router.get('/cms/url-redirects/:id', authorize('url_redirect.read'), getUrlRedirectById);

/**
 * @route   POST /api/cms/url-redirects
 * @desc    Create new URL redirect
 * @access  Private (requires 'url_redirect.create' permission)
 */
router.post('/cms/url-redirects', authorize('url_redirect.create'), createUrlRedirect);

/**
 * @route   PUT /api/cms/url-redirects/:id
 * @desc    Update URL redirect
 * @access  Private (requires 'url_redirect.update' permission)
 */
router.put('/cms/url-redirects/:id', authorize('url_redirect.update'), updateUrlRedirect);

/**
 * @route   DELETE /api/cms/url-redirects/:id
 * @desc    Delete URL redirect
 * @access  Private (requires 'url_redirect.delete' permission)
 */
router.delete('/cms/url-redirects/:id', authorize('url_redirect.delete'), deleteUrlRedirect);
 ...
 * @access  Private (requires 'url_redirect.delete' permission)
 */
router.post('/cms/url-redirects/bulk-delete', authorize('url_redirect.delete'), bulkDeleteUrlRedirects);
 ...
 * @access  Private (requires 'url_redirect.update' permission)
 */
router.patch('/cms/url-redirects/:id/toggle', authorize('url_redirect.update'), toggleUrlRedirectStatus);
