...
export default function ExtendableArticle({ className = "", name = "business-highlights" }) {
  ...
  const data = EXTENDABLE_ARTICLE_DATA[name];
  ...
  const { introData, content, buttonLabels, id } = data;
