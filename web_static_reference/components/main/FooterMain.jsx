...
export default function FooterMain({ 
  ...
  const main = MAIN_FOOTER_DATA[name];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
            ...
            <div className="lg:col-span-5 flex flex-col items-start">
                ...
                <div className="flex flex-col gap-2.5 text-body-b4 font-medium text-black">
                    <a href={`mailto:${main.contact.email}`} className="flex items-center gap-3 hover:text-yellow-500 transition-colors group">
                        <Icon name="mail" />
                        <span className="underline decoration-neutral-300 underline-offset-4 group-hover:decoration-yellow-500">{main.contact.email}</span>
                    </a>
                    <a href={`tel:${main.contact.phone}`} className="flex items-center gap-3 hover:text-yellow-500 transition-colors group">
                        <Icon name="phone" className="text-black group-hover:text-yellow-500 transition-colors" />
                        <span className="underline decoration-neutral-300 underline-offset-4 group-hover:decoration-yellow-500">{main.contact.phone}</span>
                    </a>
                </div>
                </div>
            </div>
            ...
            <div className='flex items-center gap-3'>
                ...
                <div className="flex items-center gap-4 text-black">
                    {main.socials.map((social, idx) => (
                        <a key={idx} href={social.href} className="hover:text-yellow-500 transition-colors">
