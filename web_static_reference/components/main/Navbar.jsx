              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative group/lang">
                  ...
                  <div className="absolute top-full right-0 mt-2 w-40 py-2 bg-white border border-neutral-100 rounded-xl shadow-xl opacity-0 invisible group-hover/lang:opacity-100 group-hover/lang:visible transition-all duration-200 transform origin-top-right z-50">
                    <a href="#" className="flex items-center justify-between px-4 py-2.5 text-sm text-yellow-500 bg-blue-50 font-medium">
                    ...
                    <a href="#" className="flex items-center px-4 py-2.5 text-sm text-neutral-600 hover:bg-neutral-50 hover:text-yellow-500 transition-colors font-medium">
                      <div className="flex items-center gap-2">
