  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        ...
        <span className="text-body-b5 md:text-body-b4 font-medium text-black leading-tight line-clamp-1">
          {tab.companyName}
        </span>
      </div>
...
export default function Testimonials({
  ...
  const sectionData = TESTIMONIALS_DATA[name];
  ...
  const { introData, testimonialList, companyTabs } = sectionData;
  ...
  return (
    <>
      ...
      <section
        ref={containerRef}
        className={`lnTestimonial py-16 md:py-24 bg-white overflow-hidden ${className}`}
      >
