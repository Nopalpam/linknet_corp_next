...
# **PROJECT LINKNET Media - FULL STACK WEB APPLICATION**
...
- Permission modules: users_management, role_management, menu_management, pages, contact_submissions, files, settings, log_activity, url_redirection
...
- 14 component types (Hero, TextBlock, ImageGallery, CTA, VideoEmbed, Accordion, Tabs, Testimonials, TeamGrid, StatsCounter, ContactForm, CustomHtml)
...
12. **CustomHtml** - Custom HTML embedding
...
#### **Public Components**
- HeroSection, TextBlock, ImageGallery, CallToAction, VideoEmbed, Accordion, Tabs, Testimonials, TeamGrid, StatsCounter, ContactForm, CustomHtml
