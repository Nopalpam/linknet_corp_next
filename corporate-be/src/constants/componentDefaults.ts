...
const HERO_SECTION: ComponentTypeDefinition = {
  ...
  defaultData: withCommon({
    ...
    ctaList: [{
      text: { en: 'Get Started', id: 'Mulai Sekarang' },
      href: '#',
      target: '_self',
      variant: 'primary',
      size: 'lg',
...
const VISION_MISSION: ComponentTypeDefinition = {
  ...
  defaultData: withCommon({
    introData: {
      as: 'h2',
      label: { en: '', id: '' },
      title: { en: 'Our Vision & Mission', id: 'Visi & Misi Kami' },
      description: { en: '', id: '' },
      align: 'center',
    },
    items: [
      ...
      },
      {
        ...
        title: { en: 'Our Mission', id: 'Misi Kami' },
        description: { en: 'Connecting Indonesia through innovation and excellence.', id: 'Menghubungkan Indonesia melalui inovasi dan keunggulan.' },
        image: '',
        align: 'right',
      },
    ],
