 ...
 * @access  Public
 */
router.get('/redirect/*', publicRateLimiter, handleRedirect);
...
router.use('/cms/url-redirects', authRateLimiter, authenticate);
 ...
 */
router.post('/cms/url-redirects', strictRateLimiter, authorize('url_redirection.create'), createUrlRedirect);
 ...
 */
router.put('/cms/url-redirects/:id', strictRateLimiter, authorize('url_redirection.update'), updateUrlRedirect);
 ...
 */
router.delete('/cms/url-redirects/:id', strictRateLimiter, authorize('url_redirection.delete'), deleteUrlRedirect);
 ...
 * @access  Private (requires 'url_redirection.delete' permission)
 */
router.post('/cms/url-redirects/bulk-delete', strictRateLimiter, authorize('url_redirection.delete'), bulkDeleteUrlRedirects);
 ...
 * @access  Private (requires 'url_redirection.update' permission)
 */
router.patch('/cms/url-redirects/:id/toggle', strictRateLimiter, authorize('url_redirection.update'), toggleUrlRedirectStatus);
