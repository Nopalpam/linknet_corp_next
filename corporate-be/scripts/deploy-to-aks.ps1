...
Write-Host "     Then: curl https://dev-be.lncorp.local/health" -ForegroundColor Gray
...
if ($podName) {
    ...
    try {
        $response = Invoke-RestMethod -Uri "https://dev-be.lncorp.local/health" -TimeoutSec 5
