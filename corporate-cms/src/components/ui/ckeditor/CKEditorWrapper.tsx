...
function EditorToolbar({ editor, inlineOnly = false }: { editor: Editor; inlineOnly?: boolean }) {
    ...
    return (
      <div className="border-b border-gray-200 dark:border-gray-700">
        ...
        <textarea
          ...
          placeholder="Paste HTML here, for example: <h2>Heading</h2><p>Paragraph</p><ul><li>Item</li></ul>"
          spellCheck={false}
        />
      </div>
    );
  ...
  return (
    <div className="flex flex-wrap items-center gap-0.5 px-2 py-1.5 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/60">
      ...
      <ToolbarBtn onClick={() => setIsImagePickerOpen(true)} title="Insert Image from File Manager">
        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 7a2 2 0 012-2h4l2 2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V7z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 14l2-2 2 2 3-3 3 3" /></svg>
      </ToolbarBtn>
      <MediaPickerModal
      ...
      {/* HTML Source */}
      {!inlineOnly && (
        <ToolbarBtn onClick={toggleSource} title="Edit HTML Source">
...
const CKEditorWrapper: React.FC<CKEditorWrapperProps> = ({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: 'prose prose-sm dark:prose-invert max-w-none focus:outline-none px-4 py-3 whitespace-pre-wrap',
