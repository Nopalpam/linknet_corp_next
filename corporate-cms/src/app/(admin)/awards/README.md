...
## API Endpoints
**Base URL:** `https://dev-be.lncorp.local` (dari `.env.local`)
...
Backend API harus sudah running di `https://dev-be.lncorp.local`
...
**Solution:**  
- Check backend is running at `https://dev-be.lncorp.local`
