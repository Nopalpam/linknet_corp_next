...
- **Base URL**: `NEXT_PUBLIC_API_URL` dari environment variables (default: `https://dev-be.lncorp.local`)
- **API Prefix**: `/api/v1`

Jadi, endpoint lengkap akan menjadi: `https://dev-be.lncorp.local/api/v1/[endpoint]`
